...
- [`android/`](android): All your `android`-specific implementations.
  ...
  - [`src/main/java/com/margelo/nitro/math/`](android/src/main/java/com/margelo/nitro/math/): All Kotlin implementations.
    - [`NitroMathPackage.kt`](android/src/main/java/com/margelo/nitro/math/NitroMathPackage.kt): The react-native package. You need this because the react-native CLI only adds libraries if they have a `*Package.kt` file. In here, you can autolink all Kotlin HybridObjects.
...
- [`NitroMath.podspec`](NitroMath.podspec): The iOS podspec build file to build the iOS code. This contains three important pieces:
